...
public class test022 {
    ...
    public static void main(String[] args) {
        ...
        String inputPath = "E:\\Spark_DataCleansing_DataWarehouse\\test\\处理数据\\handle_jobs2.csv";

        FileWriter fw = null;
        BufferedWriter bufw = null;
        String outPath = "E:\\Spark_DataCleansing_DataWarehouse\\test\\提取数据\\extract_jobs2.csv";
